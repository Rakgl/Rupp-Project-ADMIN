...
import type { Model } from '@/components/models/data/schema'
import { onMounted, ref } from 'vue'
import { modelsColumns } from '@/components/models/components/columns'
import DataTable from '@/components/models/components/DataTable.vue'
...
<template>
  <div class="w-full flex flex-col items-stretch gap-4">
    <div class="flex flex-wrap items-end justify-between gap-2">
      <div>
        <h2 v-t="'model.title'" class="text-2xl font-bold tracking-tight" />
        <p v-t="'model.description'" class="text-muted-foreground" />
      </div>
    </div>

    <DataTable
      :columns="modelsColumns" :data="modelsData" :meta="{ onDataChanged }"
