...
import type { Review } from '@/components/review/data/schema'
import { onMounted, ref } from 'vue'
// Make sure this points to your User Listing columns, not "carsColumns" if they differ
import { reviewsColumns } from '@/components/review/components/columns' 
import DataTable from '@/components/review/components/DataTable.vue'
