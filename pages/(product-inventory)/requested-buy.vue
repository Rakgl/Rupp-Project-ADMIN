...
import type { Transaction } from '@/components/car-sale/data/schema'
import { onMounted, ref } from 'vue'
import { transactionColumns } from '@/components/car-sale/components/columns' 
import DataTable from '@/components/car-sale/components/DataTable.vue'
...
async function fetchData() {
  ...
  try {
    const response = await api('/car-sales', { params })
...
<template>
  <div class="w-full flex flex-col items-stretch gap-4">
    <div class="flex flex-wrap items-end justify-between gap-2">
      <div>
        <h2 v-t="'reviews.title'" class="text-2xl font-bold tracking-tight" />
        <p v-t="'reviews.description'" class="text-muted-foreground" />
      </div>
    </div>
