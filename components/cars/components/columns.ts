...
import type { Car } from '../data/schema'
import { useRuntimeConfig } from '#app'
import { h } from 'vue'
import { useI18n } from 'vue-i18n'
import DataTableColumnHeader from './DataTableColumnHeader.vue'
import CarDataTableRowActions from './DataTableRowActions.vue' // Created in next step
...
export const carsColumns: ColumnDef<Car>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => {
        const { t } = useI18n()
        return h(DataTableColumnHeader, { column, title: t('stock', 'Stock') })
    },
  },
  {
    id: 'actions',
