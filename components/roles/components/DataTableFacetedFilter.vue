...
<template>
  <Popover>
      ...
      <Button variant="outline" size="sm" class="h-8 border-dashed">
        ...
        <template v-if="selectedValues.size > 0">
          ...
          <div class="hidden lg:flex space-x-1">
            ...
            <template v-else>
              <Badge v-for="item in options.filter((option: any) => selectedValues.has(option.value))" :key="item.value"
    ...
    <PopoverContent class="w-[200px] p-0" align="start">
      <Command :filter-function="(list: DataTableFacetedFilter['options'], term: any) =>
