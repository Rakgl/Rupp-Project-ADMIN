  ...
  <Popover>
      ...
      <Button variant="outline" size="sm" class="h-8 border-dashed">
        ...
        <template v-if="selectedValues.size > 0">
          ...
          <div class="hidden lg:flex space-x-1">
            ...
            >
              {{ selectedValues.size }} <LanguageText t-key="common.selected" />
            </Badge>
    ...
    <PopoverContent class="w-[200px] p-0" align="start">
      ...
      >
        ...
        <CommandList>
          <CommandEmpty><LanguageText t-key="common.noResultsFound" /></CommandEmpty>
          <CommandGroup>
            <CommandItem
          ...
          <template v-if="selectedValues.size > 0">
            ...
            <CommandGroup>
              ...
              >
                <LanguageText t-key="common.clearFilters" />
              </CommandItem>
            </CommandGroup>
          </template>
        </CommandList>
