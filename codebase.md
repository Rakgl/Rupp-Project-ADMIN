...
// --- SEARCH LOGIC ---
// Changed from 'slug' to 'search' (to match your Controller's $request->input('search'))
// OR target 'title.en' if your parent component maps that specific column to the search param.
