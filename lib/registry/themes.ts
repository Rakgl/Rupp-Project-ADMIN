  ...
  },
  {
    ...
    cssVars: {
      ...
      dark: {
        ...
        'secondary': '217 30% 14%',
        'secondary-foreground': '210 40% 86%',
        'muted': '217 25% 12%',
  ...
  },
  {
    ...
    cssVars: {
      ...
      dark: {
        ...
        'card': '215 40% 4%',
        'card-foreground': '210 100% 93%',
        'popover': '215 35% 5%',
        'popover-foreground': '210 100% 91%',
        'primary': '210 100% 85%',
        'primary-foreground': '215 50% 6%',
        'secondary': '215 25% 12%',
        'secondary-foreground': '210 100% 84%',
        'muted': '215 20% 10%',
        'muted-foreground': '210 50% 72%',
        'accent': '215 30% 15%',
        'accent-foreground': '210 100% 88%',
        'destructive': '0 75% 55%',
        'destructive-foreground': '0 0% 98%',
        'border': '215 25% 22%',
        'input': '215 25% 20%',
  ...
  },
  {
    ...
    cssVars: {
      ...
      dark: {
        ...
        'muted': '220 15% 8%',
        'muted-foreground': '45 50% 74%',
        'accent': '220 25% 13%',
        'accent-foreground': '45 100% 86%',
        'destructive': '0 75% 55%',
        'destructive-foreground': '0 0% 98%',
        'border': '220 20% 24%',
        'input': '220 20% 22%',
